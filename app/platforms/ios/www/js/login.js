...
function onDeviceReady(){   
  ...
  if(networkState == false){  // Statement for CHECK the connection
            
      navigator.notification.alert("Connessione ad Internet non disponibile! App inutilizzabile!", alertDismissed, "Attenzione", "OK");
